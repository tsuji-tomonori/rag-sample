...
async def ingest_document(
    ...
    texts = await api_functions.normalize_and_chunk_document(body, settings)
    chunks = await api_functions.embed_document_chunks(body, texts, embedder)
    await api_functions.store_document_chunks(body, chunks, chunk_store)
